...
#            print("Could not link exchanges, here are 10 examples.:") # TODO Correct the loggers to avoid the use
#            pprint(e.args[0]) # TODO of print statements, should fix segmentation faults
            self.delete_canceled_db()
